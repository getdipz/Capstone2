	...
	public void f() throws InterruptedException {
		...
		for (WebElement singleerror : list) {
			if (singleerror.getText().equals(expectedErrors[i])) {
				...
				System.out.println("Matches" + " Expected:" + expectedErrors[i] + " Actual:" + singleerror.getText());
				i++;
			} else {
				System.out.println(
						"Doesn't match" + "Expected:" + expectedErrors[i] + " Actual:" + singleerror.getText());
				i++;
			}
		}
		if (driver.findElement(By.className("hs-main-font-element")).getText().equals(expectedErrors[i])) {
			System.out.println("Matches" + " Expected:" + expectedErrors[i] + " Actual:"
					+ driver.findElement(By.className("hs-main-font-element")).getText());
		} else {
